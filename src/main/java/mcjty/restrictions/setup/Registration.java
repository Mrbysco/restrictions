...
public class Registration {
    ...
    public static final RegistryObject<BlockEntityType<?>> TYPE_PUSHER = BLOCK_ENTITIES.register("pusher", () -> BlockEntityType.Builder.of(PusherTileEntity::new, PUSHER.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<?>> TYPE_ATTRACTOR = BLOCK_ENTITIES.register("attractor", () -> BlockEntityType.Builder.of(AttractorTileEntity::new, ATTRACTOR.get()).build(null));
